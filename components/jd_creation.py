...
#                                 # Response Section - Showing file name and actions after form submission
...
#                                     dbc.Col(dbc.Button("Reset", id="reset-btn", color="secondary", className="w-100", style={'display': 'none'}), width=6),
#                                 ], className="mt-4")
#                             ]),
