                                                        ...
                                                        dbc.Col(
                                                            dbc.InputGroup(
                                                                [
                                                                    ...
                                                                    dbc.Input(
                                                                        id="jd-creation-job-title-input",
                                                                        type="text",
                                                        ...
                                                        dbc.Col(
                                                            dbc.InputGroup(
                                                                [
                                                                    ...
                                                                    dbc.Input(
                                                                        id="jd-creation-experience-input",
                                                                        type="text",
                                                    ...
                                                    [
                                                        dbc.Col(
                                                            dcc.Loading(
                                                                ...
                                                                children=[
                                                                    html.Div(
                                                                        id="jd-creation-response-section",
                                                                        className="mt-4",
                                                                    )
                                                                ],
                                                            ),
                                        ...
                                        dbc.Row(
                                            [
                                                dbc.Col(
                                                    dbc.Button(
                                                        "Save",
                                                        id="jd-creation-save-btn",
                                                        className="save-btn hide-button",
                                                    ),
                                                    width=6,
                                                ),
                                                dbc.Col(
                                                    dbc.Button(
                                                        "Discard",
                                                        id="jd-creation-reset-btn",
                                                        className="reset-btn hide-button",
                                                    ),
                                                    width=6,
                                                ),
                                            ],
